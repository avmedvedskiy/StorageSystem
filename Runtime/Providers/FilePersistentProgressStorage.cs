...
{
    public class FilePersistentProgressStorage<TProgress> : IPersistentProgressStorage<TProgress> where TProgress : class, new()
    {
        ...
        public FilePersistentProgressStorage(IJsonSerializer serializer, PersistentStorageConfig config)
        {
